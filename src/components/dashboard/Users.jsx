...
const Users = () => {
  ...
  const stats = [
    ...
    { name: 'Active This Week', value: analytics.activeUsers.toString(), icon: Activity, change: '+5%', changeType: 'positive' },
    { name: 'New This Month', value: analytics.recentRegistrations.toString(), icon: TrendingUp, change: '+15%', changeType: 'positive' },
    { name: 'Total Events', value: analytics.totalEvents.toString(), icon: BarChart3, change: '+8%', changeType: 'positive' }
  ];
      ...
      <div className="border-b border-gray-200">
        <nav className="flex space-x-8">
          {[
            ...
            { id: 'admins', name: 'Account', count: 1 }
          ].map((tab) => (
            <button
              key={tab.id}
