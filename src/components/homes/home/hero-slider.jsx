	...
	hero_title: (
		<>
			<span className="tp_title">
				<span className="child">Build Your Video</span>
			</span>{" "}
			<br />
			<span>
				<span className="child">Learning Platform</span>
			</span>{" "}
		</>
	),
	sub_title: <>Create professional websites with secure video delivery - no coding required</>,
	hero_shape_img: [
		{
			id: 1,
			cls: "1",
							...
							<div className="col-xl-10">
								<div className="tp-hero__content-box text-center z-index-3">
									...
									<div
										...
										data-wow-delay=".5s"
									>
										<div className="tp-hero__input-box">
											<input type="email" placeholder="Enter your email" />
											<button className="tp-btn-inner">Get Started</button>
										</div>
									</div>
									<p
