...
const price_data_home_one = [
    //  monthly price here 1 to 3
    {
        ...
        img: pric_img_1,
        title: "Starter",
        desctiption: <>Perfect for individual educators</>,
        cls: "",
        pric: "29.00",
        price_feature: [
            {
                list: "Drag & Drop Website Builder",
                icon: <PriceList />,
                cls: ""
            },
            {
                list: "Basic Video Embedding",
                icon: <PriceList />,
                cls: ""
            },
            {
                list: "Custom Domain Support",
                icon: <PriceList />,
                cls: "inactive"
            },
            {
    ...
    }, 
    {
        ...
        img: pric_img_2,
        title: "Professional",
        desctiption: <>Best for growing academies</>,
        cls: "active",
        pric: "79.00",
        price_feature: [
            {
                list: "Everything in Starter",
                icon: <PriceList />,
                cls: ""
            },
            {
                list: "Secure Video DRM Protection",
                icon: <PriceList />,
                cls: ""
            },
            {
    ...
    }, 
    {
        ...
        img: pric_img_3,
        title: "Enterprise",
        desctiption: <>For institutions and large teams</>,
        cls: "",
        pric: "199.00",
        price_feature: [
            {
